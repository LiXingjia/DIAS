...
class bosszhipinSpider(scrapy.Spider):
    ...
    # allowed_domains = []
    #起始页
    start_urls = ['https://www.liepin.com/zhaopin/?industries=&subIndustry=&dqs=280020&salary=&jobKind=&pubTime=&compkind=&compscale=&industryType=&searchType=1&clean_condition=&isAnalysis=&init=1&sortFlag=15&flushckid=1&fromSearchBtn=2&headckid=6f44ea5d7e881cff&d_headId=921484a3198b65d8e698a6ddc94c4cf5&d_ckId=921484a3198b65d8e698a6ddc94c4cf5&d_sfrom=search_industry&d_curPage=0&d_pageSize=40&siTag=Z057BjsU76eoyViEGMw2Dg~fA9rXquZc5IkJpXC-Ycixw&key=Html5']
