...
class bosszhipinSpider(scrapy.Spider):
    ...
    # allowed_domains = []
    #起始页
    start_urls = ['https://www.liepin.com/zhaopin/?industries=&subIndustry=&dqs=280020&salary=&jobKind=&pubTime=&compkind=&compscale=&industryType=&searchType=1&clean_condition=&isAnalysis=&init=1&sortFlag=15&flushckid=1&fromSearchBtn=2&headckid=c74f84ff96d30f6c&d_headId=5dc2567dd30a86b64fa423471767733a&d_ckId=5dc2567dd30a86b64fa423471767733a&d_sfrom=search_industry&d_curPage=0&d_pageSize=40&siTag=I-7rQ0e90mv8a37po7dV3Q%7EfA9rXquZc5IkJpXC-Ycixw&key=python']
