...
class bosszhipinSpider(scrapy.Spider):
    ...
    # allowed_domains = []
    #起始页
    start_urls = ['https://www.liepin.com/zhaopin/?industries=&subIndustry=&dqs=280020&salary=&jobKind=&pubTime=&compkind=&compscale=&industryType=&searchType=1&clean_condition=&isAnalysis=&init=1&sortFlag=15&flushckid=1&fromSearchBtn=2&headckid=03583ebb9f36eb1f&d_headId=e08e38d772260dcf5f060b91f00ecbf7&d_ckId=e08e38d772260dcf5f060b91f00ecbf7&d_sfrom=search_industry&d_curPage=0&d_pageSize=40&siTag=k_cloHQj_hyIn0SLM9IfRg~fA9rXquZc5IkJpXC-Ycixw&key=java']
